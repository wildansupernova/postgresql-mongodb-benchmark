...
INSERT_COUNT=${INSERT_COUNT:-50000}
UPDATE_MODIFY_COUNT=${UPDATE_MODIFY_COUNT:-50000}
UPDATE_ADD_COUNT=${UPDATE_ADD_COUNT:-50000}
QUERY_COUNT=${QUERY_COUNT:-50000}
DELETE_COUNT=${DELETE_COUNT:-50000}
PREFIX=${PREFIX:-test8_50000_orders_reversed}
